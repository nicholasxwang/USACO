...
public class MyCowAteMyHomework2 {
    public static float operation(ArrayList<Float> a){
        float m;
        int i;
        float s;
        float x;
...
//                PrfloatWriter prfloatWriter = new PrfloatWriter ("homework.out");
//                prfloatWriter.println(i+1);
//                prfloatWriter.close (); //No longer valid, for multipple winners
                //break;
            }else{
                if (w == -1){
                    w = s;
